...
public:
	...
	NETVAR( m_iItemDefinitionIndexSkinChanger, int32_t, FNV32( "DT_BaseAttributableItem" ), FNV32( "m_iItemDefinitionIndex" ) );
...
public:
	...
	NETVAR( m_nZoomLevel, int32_t, FNV32( "DT_WeaponCSBaseGun" ), FNV32( "m_zoomLevel" ) );
	...
	PushVirtual( GetWeaponNewData( ), 461, WeaponClassInfo_T*( __thiscall* )( void* ) );
