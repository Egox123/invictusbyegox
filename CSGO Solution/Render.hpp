...
public:
	...
	virtual void RenderRect3DFilled(Vector vecPosition, Vector vecPosition2, float_t flThickness = 1.f, Color aColor = Color::White);
	...
	virtual void DrawRing3D(int16_t x, int16_t y, int16_t z, int16_t radius, uint16_t points, Color color1, Color color2, float thickness, float prog, bool fill_prog);
