...
void C_PlayerESP::RenderName( C_BasePlayer* pPlayer )
{
	...
	if ( m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_RenderName )
		g_Render->RenderText( strName, ImVec2( m_aPlayerData[ pPlayer->EntIndex( ) ].m_aBBox.left + m_aPlayerData[ pPlayer->EntIndex( ) ].m_iWidth * 0.5f, m_aPlayerData[ pPlayer->EntIndex( ) ].m_aBBox.top - 17 ), Color(m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_aNameColor), true, true, g_Globals.m_Fonts.m_ESP);
}
...
void C_PlayerESP::RenderWeapon( C_BasePlayer* pPlayer )
{
	...
	{
		g_Render->RenderText( this->GetWeaponName( pWeapon ), ImVec2( aBox.left + ( abs( aBox.right - aBox.left ) * 0.5f ), aBox.bottom + iOffset + 3 ), Color(m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_aWeaponText), true, true, g_Globals.m_Fonts.m_ESP);
...
void C_PlayerESP::RenderFlags(C_BasePlayer* pPlayer)
{
	...
	{
		g_Render->RenderText( _S( "SCOPED" ), ImVec2( aBox.right + 3, aBox.top + iOffset ), m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Colors[ 0 ], false, true, g_Globals.m_Fonts.m_Flags );
		iOffset += 12;
	}

	if ( pPlayer->m_ArmourValue( ) > 1  && m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Flags[ 1 ] )
	{
		g_Render->RenderText( pPlayer->m_bHasHelmet( ) && pPlayer->m_ArmourValue( ) > 0 ? _S( "HK" ) : ( pPlayer->m_bHasHelmet( ) ? _S( "H" ) : _S( "K" ) ), ImVec2( aBox.right + 3, aBox.top + iOffset ), m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Colors[ 1 ], false, true, g_Globals.m_Fonts.m_Flags);
		iOffset += 12;
	}

	if ( pPlayer->m_flFlashTime() > 0.1f  && m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Flags[ 2 ]  )
	{
		g_Render->RenderText( _S( "FLASHED" ), ImVec2( aBox.right + 3, aBox.top + iOffset ), m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Colors[ 2 ], false, true, g_Globals.m_Fonts.m_Flags);
		iOffset += 12;
	}
	...
	if ( strlen( pPlayer->m_szLastPlaceName( ) ) > 1  && m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Flags[ 3 ]  )
	{
		...
		if (last_place && *last_place)
		{
			...
			g_Render->RenderText( st, ImVec2( aBox.right + 3, aBox.top + iOffset ), m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Colors[ 3 ], false, true, g_Globals.m_Fonts.m_Flags);
		}
	...
	g_Render->RenderText( money.str( ), ImVec2( aBox.right + 3, aBox.top + iOffset ), m_aPlayerData[ pPlayer->EntIndex( ) ].m_aSettings.m_Colors[ 4 ], false, true, g_Globals.m_Fonts.m_Flags);
}
