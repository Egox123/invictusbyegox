...
namespace ImGui
{
    ...
    void KeyBindPopUp(void* v, const char* label, int8_t data_constant, const std::vector<const char*>* arr_data = nullptr);
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, int allign_mode = 1);
    IMGUI_API bool          ColorPicker3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
    IMGUI_API bool          ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0,0), int allign_mode = 1);  // display a colored square/button, hover for details, return true when pressed.
    ...
    IMGUI_API bool          CustomSelectable(const char* label, bool selected, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
